...
3. Enter **Taskbar Fluent Media Player** in the search field.
4. In the results, select [Taskbar Fluent Media Player](https://windhawk.net/mods/taskbar-fluent-media-player).
